...
{
  "documentNumber": "رقم الكتاب الأصلي بالكامل وبدقة فائقة كما هو مكتوب بالوثيقة بالتمام والكمال دون أي اختصار أو حذف لأي جزء أو رمز مائل أو شرطة (مثال: م.أ/123/456)",
  ...
  "documentContent": "النص الكامل والشامل والتحليلي لمحتوى الكتاب كما هو بالتمام والكمال (من البداية للنهاية كلمة بكلمة ودون زيادة أو نقصان أو تلخيص أو حذف)، مصحح لغوياً بشكل ممتاز وخالي من أي حروف متقطعة أو كلمات غير مفهومة. يجب أن يكون النص مقروءاً بوضوح ومطابقاً تماماً للمستند الأصلي.",
  "confidenceScore": 95,
...
3. يجب كتابة النص الكامل للكتاب في حقل (documentContent) بشكل مطابق جداً وحرفي دون تلخيص أو صياغة تعبيرية مبتدعة خارج سياق النص الأصلي.
4. بالنسبة لجميع الأرقام والتواريخ وجهات الإصدار، يجب أن تكون مطابقة وحرفية ومأخوذة من متن أو ترويسة أو أسفل الكتاب الرسمي بدقة 100% دون حذف أو اختصار لأي علامات مائلة (/) أو شرطات (-) أو أحرف مرافقة للرقم.
